...
- <u>Paraphrase</u> strengths/weaknesses of editing a website directly through GitHub
- <u>Use</u> GitHub to edit an existing website
- <u>Explain</u> what to do if a GitHub Action fails after editing through GitHub
...
![](images/edit-in-gh-01.png){fig-alt="Screenshot of the contents of a single file in a GitHub repository" .lightbox}
...
![](images/edit-in-gh-02.png){fig-alt="Screenshot of the contents of a single file in a GitHub repository in the editing interface" .lightbox}

After you make any edits, the "Commit changes..." button will become click-able.

![](images/edit-in-gh-03.png){fig-alt="Screenshot of the contents of a single file in a GitHub repository in the editing interface after some edits have been made" .lightbox}
...
![](images/edit-in-gh-04.png){fig-alt="Screenshot of the 'commit changes' pop-up menu that appears when you are editing files directly through GitHub" width="60%" fig-align="center" .lightbox}
