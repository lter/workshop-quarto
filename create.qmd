...
If you name a repository "**<span style="color:purple">owner</span>**.github.io" (so the repository link is "github.com/**<span style="color:purple">owner</span>**/**<span style="color:purple">owner</span>**.github.io") then the website's URL is simplified to be the _same as the repository name_ (i.e., "**<span style="color:purple">owner</span>**.github.io").
